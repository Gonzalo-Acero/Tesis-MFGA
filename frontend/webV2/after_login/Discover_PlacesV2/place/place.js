...
(function () {
  ...
  const discoverUrl = '../discoverplacesfirstpage/discover.html';
  ...
  async function init() {
    ...
    try {
      ...
      if (!dest) {
        renderNotFound(`We could not find a place with ID "${escHtml(id)}".`);
        return;
      }
  ...
  function renderPlace(d) {
    placeMain.innerHTML = `
      ...
      <section class="place-hero">
        ...
        <div class="hero-text">
          ...
          <p class="hero-location">
            ...
            ${escHtml(d.city)}, ${escHtml(d.province)} &middot; Argentina
          </p>
        </div>
      </section>
      ...
      <div class="place-content">
        ...
        <!-- CTA BUTTONS -->
        <div class="place-cta">
          <a class="btn btn-outline" href="${discoverUrl}">
  ...
  function renderNotFound(msg) {
    placeMain.innerHTML = `
      <div class="not-found-state">
        ...
        <p>${escHtml(msg)}</p>
        <a class="btn btn-primary" href="${discoverUrl}">
          <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="m12 19-7-7 7-7"/><path d="M19 12H5"/></svg>
          Back to Discover
        </a>
      </div>
